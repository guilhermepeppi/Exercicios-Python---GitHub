...
# feita a um grande quantidade de organizações: "Qual o melhor Sistema
...
# valores referentes a cada uma das opções devem ser armazenados num vetor. Após
# os dados terem sido completamente informados, o programa deverá calcular a
