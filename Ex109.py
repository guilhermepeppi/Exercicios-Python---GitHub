...
# quanto será gasto com o pagamento deste abono. Após reuniões envolvendo a
# diretoria executiva, a diretoria financeira e os representantes do sindicato
...
# digitação. Após a entrada de todos os dados o programa deverá calcular o valor
# do abono concedido a cada colaborador, de acordo com a regra definida acima.
# Ao final, o programa deverá apresentar: O salário de cada funcionário,
# juntamente com o valor do abono; O número total de funcionários processados; O
# valor total a ser gasto com o pagamento do abono; O número de funcionários que
# receberão o valor mínimo de 100 reais; O maior valor pago como abono;
